...
const AddRoom = () => {
  ...
  return (
    <form className='' onSubmit={onSubmitHandler}>
          ...
          <div className="w-ful flex max-sm:flex-col sm:gap-4 mt-4">
            <div className="flex-1 max-w-48">
                <p className='text-gray-800 mt-4'> Room Type</p>
                <select value={inputs.roomType} onChange={e => setInputs({...inputs, roomType: e.target.value})}
                className='border opacity-70 border-gray-300 outline-none mt-1 rounded p-2 w-full'>
                    <option value="">Select Rom Type</option>
                    <option value="Single Bed">Single Bed</option>
                    <option value="Luxury Bed">Double Bed</option>
            ...
            <div>
                ...
                <input type="number" placeholder='0' className='border outline-none border-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e=> setInputs({...inputs, pricePerNight: e.target.value})} />
            </div>
          </div>
