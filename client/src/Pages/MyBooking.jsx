...
<div className="max-w-6xl mt-8 w-full text-gray-800">
      <div className="hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3">
        <div className='w-2/3'>Hotels</div>
        ...
        bookings.map((booking) => (
          <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t" key={booking._id}>
            ...
            <div className="flex flex-col md:flex-row">
              <img src={booking.room.images[0]} alt="hotle-img"  className='min-md:w-44 rounded shadow object-cover'/>
            ...
            <div className="flex flex-col items-start justify-center pt-3">
               <div className="flex items-center gap-2">
                ...
                <p className={`h-3 w-3 rounded-full ${booking.isPaid ? 'text-green-700' : 'text-red-700'}`}> {booking.isPaid ?  "Paid" : "Unpaid"}</p>
               </div>
               {!booking.isPaid && (
