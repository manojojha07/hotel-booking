...
'/>
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded g active:scale-95 transition-all">Subscribe
                <img src={assets.arrowIcon} className='invert w-5 opacity-90  group-hover:translate-x-1 transition-all' alt="arrow-icon" />
                </button>
            </div>
