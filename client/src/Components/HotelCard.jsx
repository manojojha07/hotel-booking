    ...
    {index % 2 === 0 &&  <p className='px-3 py-1 absolute top-3 left-3 text-xs bg-white text-gray-800 font-medium rounded-full'>Best Seller</p> }
      <div className="p-4 pt-5">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button className='px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-200 transition-all cursor-pointer duration-300'>Book Now</button>
        </div>
      </div>
    </Link>
  )
